...
PA_KILL_EXISTING=false PA_NETWORK_LAG_MIN_MS=20 PA_NETWORK_LAG_MAX_MS=600 zsh run_client.sh Amber &PA_KILL_EXISTING=false zsh run_client.sh Hayley &  # no lag — "perfect fiber" peer; tests asymmetric case
