...
---@diagnostic disable-next-line: duplicate-set-field
  ...
  local desktopSizeLabel = ui.Label({text = "Desktop size: " .. dWidth .. "x" .. dHeight})
  ...
  self.uiRoot.widthSlider = ui.Slider({
    min = dWidth - 200,
    max = dWidth + 200,
    value = width,
    tickLength = 2,
  ...
  self.uiRoot.heightSlider = ui.Slider({
    min = dHeight - 200,
    max = dHeight + 200,
    value = height,
    tickLength = 2,
  ...
  grid:createElementAt(1, 6, 2, 1, nil, ui.Label({text = "height", translate = false}))
  grid:createElementAt(3, 6, 20, 1, "height", self.uiRoot.heightSlider)
  grid:createElementAt(1, 7, 2, 1, nil, ui.Label({text = "x", translate = false}))
  grid:createElementAt(3, 7, 20, 1, "x", self.uiRoot.xSlider)
  grid:createElementAt(1, 8, 2, 1, nil, ui.Label({text = "y", translate = false}))
