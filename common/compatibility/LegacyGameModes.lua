...
---@overload fun(mode: "ONE_PLAYER_VS_SELF"): LegacyGameMode
---@overload fun(mode: "ONE_PLAYER_TIME_ATTACK"): LegacyGameMode
---@overload fun(mode: "ONE_PLAYER_ENDLESS"): LegacyGameMode
---@overload fun(mode: "ONE_PLAYER_TRAINING"): LegacyGameMode
